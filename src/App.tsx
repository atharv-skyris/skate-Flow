        ...
        <div className="max-w-7xl mx-auto px-6 md:px-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            >
              ...
              <div className="text-4xl font-black text-white">₹ 1,500 <span className="text-base text-neutral-500 font-medium tracking-normal">/ program</span></div>
            </motion.div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          >
            <div className="w-40 h-40 rounded-full overflow-hidden border-2 border-lime-400/20 mb-6 group-hover:border-lime-400 transition-colors">
              <img 
                src="https://picsum.photos/seed/rohan/400/400" 
                alt="Rohan Malik" 
                className="w-full h-full object-cover grayscale group-hover:grayscale-0 transition-all duration-500"
                referrerPolicy="no-referrer"
              />
            </div>
            <h3 className="text-xl font-black uppercase tracking-tight">Rohan Malik</h3>
          ...
          >
            <div className="w-40 h-40 rounded-full overflow-hidden border-2 border-blue-400/20 mb-6 group-hover:border-blue-400 transition-colors">
              <img 
                src="https://picsum.photos/seed/sana/400/400" 
                alt="Sana Varma" 
                className="w-full h-full object-cover grayscale group-hover:grayscale-0 transition-all duration-500"
                referrerPolicy="no-referrer"
              />
            </div>
            <h3 className="text-xl font-black uppercase tracking-tight">Sana Varma</h3>
            ...
            <div>
              ...
              <div className="space-y-8">
                <a href="tel:+919876543210" className="flex items-center gap-6 group">
                  ...
                  <span className="text-2xl md:text-3xl font-black tracking-tight">+91 98XXX XXXXX</span>
                </a>
                <a href="mailto:flow@skate.academy" className="flex items-center gap-6 group">
                  <div className="w-16 h-16 rounded-full bg-white/5 border border-white/10 flex items-center justify-center group-hover:bg-lime-400 transition-colors">
                    <Mail className="text-white group-hover:text-black transition-colors" size={24} />
                  </div>
                  <span className="text-2xl md:text-3xl font-black tracking-tight">ENROLL@SKATEFLOW.IN</span>
                </a>
              </div>
            </div>
